...
pinned: false
description: "如何使用 Rain 博客模板。"
aiSummary: 这篇入门指南围绕 Front-matter、文章目录和 slug 展开，给出从新建 Markdown 文件到自定义文章 URL 的最小配置和注意事项。
image: "./cover.webp"
tags: ["Rain", "博客", "Markdown", "使用指南"]
category: 博客指南
draft: true
---
...
```yaml
---
title: 如何使用 Rain 博客主题
published: 2023-09-09
slug: how-to-use-firefly-blog-theme
---
```
文件：`src/content/posts/如何使用Rain博客主题.md`
